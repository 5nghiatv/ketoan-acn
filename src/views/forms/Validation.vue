  ...
  <CRow>
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-medium-emphasis small">
            ...
            <code>novalidate</code> boolean property to your <code>&lt;CForm&gt;</code>. This disables the browser
            default feedback tooltips, but still provides access to the form validation APIs in JavaScript. Try to
            submit the form below; our JavaScript will intercept the submit button and relay feedback to you. When
            attempting to submit, you&#39;ll see the <code>:invalid</code> and <code>:valid</code> styles applied
          ...
          <DocsExample href="forms/validation.html">
            ...
            >
              ...
              <CCol :xs="12">
                <CFormCheck id="invalidCheck" type="checkbox" label="Agree to terms and conditions" required />
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-medium-emphasis small">
            ...
            All good, you can use the browser defaults. Try submitting the form below. Depending on your browser
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <p class="text-medium-emphasis small">
            ...
            field using
            <code>aria-describedby</code> (noting that this attribute allows more than one <code>id</code> to be
        ...
        <CCardBody>
          ...
          <DocsExample href="forms/validation.html#supported-elements">
            <CForm :validated="true">
              ...
              <CFormCheck id="validationFormCheck1" class="mb-3" label="Check this checkbox" required />
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-medium-emphasis small">
            If your form layout allows it, you can swap the text for the tooltip to display validation feedback in
            a styled tooltip. Be sure to have a parent with
            <code>position: relative</code> on it for tooltip positioning. In the example below, our column classes
            have this already, but your project may require an alternative setup.
          </p>
