<template>
  <CRow>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Checkbox</strong> <small>Disabled</small> </CCardHeader>
        <CCardBody>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Radio</strong> <small>Disabled</small> </CCardHeader>
        <CCardBody>
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-medium-emphasis small">
            ...
            <code>switch</code> boolean properly to render a toggle switch. Switches also support the
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Switches</strong> <small>Sizes</small> </CCardHeader>
        <CCardBody>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Checks and Radios</strong> <small>Inline</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Checks and Radios</strong> <small>Without labels</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-medium-emphasis small">
            ...
            <code>button</code> boolean property on the <code>&lt;CFormCheck&gt;</code> component. These toggle
            buttons can further be grouped in a button group if needed.
          </p>
          <DocsExample href="forms/checks-radios.html#toggle-buttons">
            <CFormCheck id="btn-check" :button="{ color: 'primary' }" autocomplete="off" label="Single toggle" />
          </DocsExample>
          <DocsExample href="forms/checks-radios.html#toggle-buttons">
            <CFormCheck
              id="btn-check-2"
