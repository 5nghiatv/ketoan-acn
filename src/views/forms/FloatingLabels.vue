<template>
  <CRow>
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-medium-emphasis small">
            ...
            <code>CFormFloating</code> to enable floating labels with textual form fields. A
            <code>placeholder</code> is required on each <code>&lt;CFormInput&gt;</code> as our method of CSS-only
            floating labels uses the <code>:placeholder-shown</code> pseudo-element. Also note that the
            <code>&lt;CFormInput&gt;</code> must come first so we can utilize a sibling selector (e.g.,
            <code>~</code>).
          </p>
          <DocsExample href="forms/floating-labels.html">
            <CFormFloating class="mb-3">
              <CFormInput id="floatingInput" type="email" placeholder="name@example.com" />
              <CFormLabel for="floatingInput">Email address</CFormLabel>
            </CFormFloating>
            <CFormFloating>
              <CFormInput id="floatingPassword" type="password" placeholder="Password" />
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Floating labels</strong> <small>Textareas</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
          ...
          <p class="text-medium-emphasis small">
            ...
            <code>rows</code> attribute. Instead, set an explicit <code>height</code> (either inline or via custom
            CSS).
          </p>
          <DocsExample href="forms/floating-labels.html#textareas">
            <CFormFloating>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Floating labels</strong> <small>Selects</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
            ...
            <code>&lt;CFormInput&gt;</code>s, they&#39;ll always show the <code>&lt;CFormLabel&gt;</code> in its
            floated state.
            <strong> Selects with <code>size</code> and <code>multiple</code> are not supported. </strong>
          </p>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Floating labels</strong> <small>Layout</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
