<template>
  <CRow>
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-medium-emphasis small">
            Vue Alert is prepared for any length of text, as well as an optional close button. For a styling, use
            one of the
            <strong>required</strong> contextual <code>color</code> props (e.g., <code>primary</code>). For inline
            dismissal, use the
            <a href="https://coreui.io/vue/docs/4.0/components/alert.html#dismissing"> dismissing prop </a>
            .
          </p>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Alert</strong> <small>Link color</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
          ...
          <DocsExample href="components/alert.html#link-color">
            <CAlert color="primary">
              ...
              <CAlertLink href="#">an example link</CAlertLink>. Give it a click if you like.
            </CAlert>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Alert</strong> <small>Additional content</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
            Alert can also incorporate supplementary components &amp; elements like heading, paragraph, and
            divider.
          </p>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Alert</strong> <small>Dismissing</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
