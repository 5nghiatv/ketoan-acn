<template>
  <CRow>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Button Group</strong> <span>Basic example</span> </CCardHeader>
        <CCardBody>
          <p>Wrap a series of <code>&lt;CButton&gt;</code> components in <code>&lt;CButtonGroup&gt;</code>.</p>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Button Group</strong> <span>Mixed styles</span> </CCardHeader>
        <CCardBody>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Button Group</strong> <span>Outlined styles</span> </CCardHeader>
        <CCardBody>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <DocsExample href="components/button-group.html#checkbox-and-radio-button-groups">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Button Group</strong> <span>Button toolbar</span> </CCardHeader>
        <CCardBody>
          <p>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Button Group</strong> <span>Sizing</span> </CCardHeader>
        <CCardBody>
          <p>
            Alternatively, of implementing button sizing classes to each button in a group, set
            <code>size</code> property to all <code>&lt;CButtonGroup&gt;</code>&#39;s, including each one when
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Button Group</strong> <span>Nesting</span> </CCardHeader>
        <CCardBody>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Button Group</strong> <span>Vertical variation</span> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
