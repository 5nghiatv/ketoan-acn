      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-medium-emphasis small">
            CoreUI includes a bunch of predefined buttons components, each serving its own semantic purpose.
            Buttons show what action will happen when the user clicks or touches it. CoreUI buttons are used to
            initialize operations, both in the background or foreground of an experience.
          </p>
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <p class="text-medium-emphasis small">
            ...
            <code>role=&#34;button&#34;</code> to adequately communicate their meaning to assistive technologies
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-medium-emphasis small">
            ...
            <code>pointer-events: none</code> applied to, disabling hover and active states from triggering.
          </p>
          ...
          <p class="text-medium-emphasis small">
            ...
            <code>.disabled</code> class to make buttons look inactive. CoreUI also has to add to the disabled
            button component <code>aria-disabled=&#34;true&#34;</code> attribute to show the state of the component
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <p class="text-medium-emphasis small">
            ...
            <code>md</code> breakpoint, where <code>.d-md-block</code> replaces the <code>.d-grid</code> class,
            thus nullifying the <code>gap-2</code> utility. Resize your browser to see them change.
          </p>
          <DocsExample href="components/button.html#block-buttons">
          ...
          <p class="text-medium-emphasis small">
            ...
            taken our previous responsive example and added some flex utilities and a margin utility on the button
            to right align the buttons when they&#39;re no longer stacked.
          </p>
          <DocsExample href="components/button.html#block-buttons">
