  ...
  <CRow>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-medium-emphasis small">
            The main block of a card is the <code>&lt;CCardBody&gt;</code>. Use it whenever you need a padded
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-medium-emphasis small">
            ...
            <code>&lt;CCardTitle&gt;</code> component. Identically, links are attached and collected next to each
            other by
            <code>&lt;CCardLink&gt;</code>
            component.
          </p>
          <p class="text-medium-emphasis small">
            ...
            <code>&lt;CCardSubtitle&gt;</code> component. If the <code>&lt;CCardTitle&gt;</code> also, the
            <code>&lt;CCardSubtitle&gt;</code> items are stored in a <code>&lt;CCardBody&gt;</code> item, the card
          ...
          <DocsExample href="components/card/#titles-text-and-links">
            <CCard style="width: 18rem">
              <CCardBody>
                <CCardTitle>Card title</CCardTitle>
                <CCardSubtitle class="mb-2 text-medium-emphasis">Card subtitle</CCardSubtitle>
                <CCardText>
                  Some quick example text to build on the card title and make up the bulk of the card&#39;s
                  content.
                </CCardText>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-medium-emphasis small">
            <code>.card-img-top</code> places a picture to the top of the card. With <code>.card-text</code>, text
            can be added to the card. Text within <code>.card-text</code> can additionally be styled with the
            regular HTML tags.
          </p>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-medium-emphasis small">
            Combine and match many content types to build the card you need, or throw everything in there. Shown
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-medium-emphasis small">
            Cards assume no specific <code>width</code> to start, so they&#39;ll be 100% wide unless otherwise
            stated. You can adjust this as required with custom CSS, grid classes, grid Sass mixins, or services.
          </p>
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <p class="text-medium-emphasis small">
            ...
            <code>text-color</code> property on the <code>&lt;CCard&gt;</code> or a subset of the card&#39;s
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-medium-emphasis small">
            ...
            property to control how many grid columns (wrapped around your cards) you show per row. For example,
            here&#39;s
            <code>xs="&#123;cols: 1&#125;"</code> laying out the cards on one column, and
            <code>md="&#123;cols: 1&#125;"</code> splitting four cards to equal width across multiple rows, from
