<template>
  <CRow>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Spinner</strong> <small>Border</small> </CCardHeader>
        <CCardBody>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Spinner</strong> <small>Growing</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
            If you don&#39;tfancy a border spinner, switch to the grow spinner. While it doesn&#39;t technically
          ...
          <p class="text-medium-emphasis small">
            Once again, this spinner is built with <code>currentColor</code>, so you can easily change its
            appearance. Here it is in blue, along with the supported variants.
          </p>
          <DocsExample href="components/spinner.html#growing-spinner">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Spinner</strong> <small>Size</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Spinner</strong> <small>Buttons</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
