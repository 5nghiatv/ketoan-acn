<template>
  <CRow>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue List Group</strong> <small>Basic example</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
            The default list group is an unordered list with items and the proper CSS classes. Build upon it with
            the options that follow, or with your CSS as required.
          </p>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue List Group</strong> <small>Active items</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue List Group</strong> <small>Disabled items</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue List Group</strong> <small>Links and buttons</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
            Use <code>&lt;a&gt;</code>s or <code>&lt;button&gt;</code>s to create <em>actionable</em> list group
            items with hover, disabled, and active states by adding <code>component=&#34;a|button&#34;</code>. We
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue List Group</strong> <small>Flush</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue List Group</strong> <small>Horizontal</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue List Group</strong> <small>Contextual classes</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
          ...
          <DocsExample href="components/list-group.html#contextual-classes">
            <CListGroup>
              <CListGroupItem>Dapibus ac facilisis in</CListGroupItem>
              <CListGroupItem
                v-for="item in ['primary', 'secondary', 'success', 'danger', 'warning', 'info', 'light', 'dark']"
                :key="item"
                :color="item"
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue List Group</strong> <small>With badges</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue List Group</strong> <small>Custom content</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue List Group</strong> <small>Checkboxes and radios</small> </CCardHeader>
        <CCardBody>
          <p class="text-medium-emphasis small">
