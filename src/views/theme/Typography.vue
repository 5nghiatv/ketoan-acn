      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p>
            ...
            a heading to stand out, consider using a <strong>display heading</strong>—a larger, slightly more
            ...
            <dl class="row">
              ...
              <dd class="col-sm-9">
                <dl class="row">
                  ...
                  <dd class="col-sm-8">Aenean posuere, tortor sed cursus feugiat, nunc augue nunc.</dd>
                </dl>
              </dd>
            </dl>
          </div>
